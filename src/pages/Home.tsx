...
function Home() {
  ...
  return (
    <>
      <Seo
        title="Home"
        description="Ocienns Inc. is a premium car dealership offering quality vehicles, flexible financing, and easy test drive booking."
      />
          ...
          <div className={styles.heroGrid}>
            ...
            <Reveal className={styles.heroMedia} delay={120}>
              <img
                ...
                alt="Rows of vehicles for sale on the Ocienns Inc. dealership lot"
                width={960}
                height={699}
                loading="eager"
                fetchPriority="high"
      ...
      <section className={styles.whySection}>
        <Container>
          <SectionHeading
            title="Why Buyers Choose Ocienns Inc."
